...
import * as service from '~/api/services/home-product.service'
import { HomeProduct } from '~/models/home-product.model'
import { RequestBodyType } from '~/type'
import { message } from '../utils/constant'

const NAMESPACE = 'controllers/home-product'

export default class HomeProductController {
  constructor() {}
