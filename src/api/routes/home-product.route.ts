...
import HomeProductController from '../controllers/home-product.controller'
import { validationRules } from '../middleware/request-validator'

class HomeProductRoute {
  router = Router()
  controller = new HomeProductController()
...
export default new HomeProductRoute().router
