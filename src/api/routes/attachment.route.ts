...
class AttachmentRoute {
  ...
  private initialize() {
    ...
    this.router.post(
      '/',
      validationRules([
        { field: 'url', fieldType: 'string', location: 'body' },
        { field: 'type', fieldType: 'string', location: 'body' },
        { field: 'caption', fieldType: 'string', location: 'body' }
      ]),
...
export default new AttachmentRoute().router
